    ...
    <div class="banner-form2-body" >
        ...
        <form id="form1" name="form1" method="post" action="">
            ...
            <div class="row"> 
                ...
                <div class="col-md-6 padding-5a">
                    <input type="text" name="phone" id="phone"  placeholder="Phone"  class="form-textbox" pattern="[0-9]{10}" required />
                </div>
                <div class="col-md-6 padding-5a">
        ...
        <nav class="mainNav">
            ...
            <ul>
                           <?php
                                    ...
                                    $db->Fetch(TABLE_TEST_PREPARATION,NULL,NULL," where status=1 AND id!={$_GET['id']} order by sortorder ASC");
...
$db->Fetch(TABLE_BLOG_MNG,NULL,NULL," order by id DESC limit 2");
...
?>
        ...
        <div class="services-button">
            <a href="blog" class="btn-service btn-md">VIEW ALL</a> 
        </div>
