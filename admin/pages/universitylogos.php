...
if(isset($_POST) && !empty($_POST)){   
    ...
    if(isset($_POST['id'])){ 
                            ...
                            {
                                $db->FetchSingle(TABLE_UNIVERSITY_LOGOS,'image',array(array('where','id',$_POST['id'])));
                            ...
                            { 
                                   if($db->Update(TABLE_UNIVERSITY_LOGOS,array('image'=>$url,'alt_tag'=>$_POST['alt_tag'],'link_url'=>$_POST['link_url'],'university_name'=>$_POST['university_name'],'sortorder'=>$_POST['sortorder'],'status'=>1,'add_date'=>TODAY,'ip'=>USER_IP),array(array('where','id',$_POST['id']))))
                            {
                ...
                if($_FILES['banner']['name']!="")
                {
                            ...
                            if($db->Insert(TABLE_UNIVERSITY_LOGOS,array('image'=>$url,'alt_tag'=>$_POST['alt_tag'],'link_url'=>$_POST['link_url'],'university_name'=>$_POST['university_name'],'sortorder'=>$_POST['sortorder'],'status'=>1,'add_date'=>TODAY,'ip'=>USER_IP)))
                            {
    ...
    header('location:universitylogos.php');
}
...
<head>
    ...
    <title>Manage University Logos</title>
    <!-- DataTables CSS -->
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Delete</th>
                                                                        ...
                                                                        <tbody>
<?php $xx=1;
$db->Fetch(TABLE_UNIVERSITY_LOGOS,NULL,NULL," order by id DESC");
...
?>                                    
                                        <tr class="odd gradeX" id="row<?= $xx;?>">
                                            ...
                                            <div class="onoffswitch">
                                                <input type="checkbox" onClick="status('<?=TABLE_UNIVERSITY_LOGOS;?>','status','<?= $v['id']?>')"  name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch<?= $v['id']?>" <?php if($v['status']==1){ echo "checked";} ?> >
                                            ...
                                            <td align="center"class="center"><a href="javascript:" onClick="delete_col('<?=TABLE_UNIVERSITY_LOGOS;?>','row<?= $xx;?>','<?= $v['id']?>')"><i class="fa fa-trash-o fa-2x"></i></a></td>
                                        </tr>
<?php $xx++;}?>                                        
                                    </tbody>
    ...
    $(document).ready(function() {
        ...
        <script type="text/javascript">
            function show_dialog(str){
                $.post("../ajax/model.php",{"choice":"universitylogos","id":str},function(respond){
