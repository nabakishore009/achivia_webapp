...
error_reporting(0);
	...
	$mcFileManagerConfig['filesystem.path'] = '../upload_image'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = '../../../upload_image'; // absolute or relative from this script path.
