...
error_reporting(0);
	...
	//$mcFileManagerConfig['preview.wwwroot'] = ''; // absolute or relative from this script path (c:/Inetpub/wwwroot).
        $mcFileManagerConfig['preview.wwwroot'] = '/home/abhchi/public_html/flyoriole.com'; // absolute or relative from this script path (c:/Inetpub/wwwroot).
	...
	$mcFileManagerConfig['filesystem.path'] = '/home/abhchi/public_html/flyoriole.com/upload_image'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = '/home/abhchi/public_html/flyoriole.com/upload_image'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,swf,avi";
