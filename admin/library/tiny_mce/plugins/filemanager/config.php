...
error_reporting(0);
	...
	$mcFileManagerConfig['filesystem.path'] = '../upload_images'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = '../../../../upload_images'; // absolute or relative from this script path.
