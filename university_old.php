...
<html lang="en">
    ...
    <body>
        ...
        $country_name = getsingleRow($countryname_sql) 
            ?>
                        <h2><?php echo $country_name['country_name']; ?></h2>
                        <ul>
                            <li>Home / </li> 
                            <li>
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="list">
                                                    <ul>
                                                        ...
                                                        while ($countrt_pointers = getsingleRow($country_pointersql)) {
                                                            ...
                                                            <li><a href="#<?php print $href1; ?>" ><?php echo $countrt_pointers['pointer']; ?> </a></li>  
                                                ...
                                                <div class="servise-page-text">
                                                    ...
                                                    while ($country_details = getsingleRow($country_detailssql)) {
                                                        ...
                                                        ?>
                                                        <div id="<?php print $href2; ?>" class="lock-heading"><h3><div style="color: #0070c0;font-family: Verdana, serif;font-size: small;"><strong><?php echo $country_details['pointer']; ?> <?php if(!empty($_SESSION['uid']) && isset($_SESSION['uid'])){ } else if ($country_details['lock_status'] == 1) { ?><span class="lock" data-toggle="modal" data-target="#myModal" ><i class="fa fa-lock" aria-hidden="true"></i></span><?php } ?></strong></div></h3></div>
                                                        <?php 
